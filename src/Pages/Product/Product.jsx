      ...
      <article className='flex-column container'>
        ...
        <div className='flex-center product-details__content'>
          ...
          <div className='flex-column column product-details__text'>
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut eu velit non dui
              mollis pharetra vel nec turpis. Quisque euismod ultricies ligula nec
              posuere. Praesent dapibus felis ullamcorper sapien porta, ac sollicitudin ex
              tincidunt. Nulla et urna sed orci elementum tempor sit amet ut justo.
